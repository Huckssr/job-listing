class JobsController < ApplicationController
  ...
  @jobs = case params[:order]
          ...
          when 'by_lower_bound'
            ...
            Job.recent.published.paginate(:page => params[:page], :per_page => 20)
          end
end
...
private
  ...
  def job_params
    params.require(:job).permit(:title, :description, :diqu, :wage_upper_bound, :wage_lower_bound, :contact_email,:is_hidden)
  end
end
